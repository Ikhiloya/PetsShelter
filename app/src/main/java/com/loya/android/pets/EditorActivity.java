...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int PET__EDIT_LOADER = 1;
...
//    private ContentValues values;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in order to figure outif we are creating a new pet or editing an existing one
        Intent intent = getIntent();
        mCurrentPetUri = intent.getData();


        //if the intent DOES not contain a pet URI. then we know that we are creating a new pet
        if (mCurrentPetUri == null || mCurrentPetUri.getScheme() == null) {
            //This is a new pet so change the app bar to sa "Add a Pet"
            ...
            //kick-off the loader
            getLoaderManager().initLoader(PET__EDIT_LOADER, null, this);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                savePet();
                finish(); //closes/Exit the EditorActivity
